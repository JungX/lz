...
define(
	function () {
		return ['$compile', '$templateCache', '$animate', '$document', '$rootScope', '$q', '$timeout', ImagePreviewService];
		function ImagePreviewService($compile, $templateCache, $animate, $document, $rootScope, $q, $timeout) {
			...
			var loadImage = function (i) {
				...
				image.src = 'images/origin/' + scope.images[i].id;
				scope.loading = true;
