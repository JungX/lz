define(['angular'], function (angular) {
	...
	return ['$animate', '$document', '$compile', '$controller', '$rootScope', '$q', '$templateRequest', '$timeout', ModalService];

	function ModalService($animate, $document, $compile, $controller, $rootScope, $q, $templateRequest, $timeout) {
		var parentTemplate = '<div class="popbox weui-mask"></div>';
			...
			self.showModal = function (options) {
				...
				getTemplate(options.template, options.templateUrl)
					.then(function (template) {
						...
						var linkFn = $compile(parentTemplate);
						var modalElement = linkFn(modalScope);

						var element = $compile(template)(modalScope);
						appendChild(modalElement, element);
